...
angular.module('notificationsApp').controller('notificationsListCtrl', ['$scope', '$filter', function ($scope, $filter)
{
   ...
   */
  $scope.notifications = [
    { text: 'notification 1', time: '4m', class: 'success', iconClasses: 'fa fa-check', seen: true },
    { text: 'New user Registered', time: '10m', class: 'user', iconClasses: 'fa fa-user', seen: false },
